            ...
            <form action="{{ url('admin/addHangjiaRes') }}" method="post" class="add-article-form" enctype="multipart/form-data">
                <div class="col-md-9">
                    ...
                    <div class="form-group">
                        ...
                        <div style="float:left;line-height:34px;"><label style="padding-left:20px;">显示<input type="radio" name="xuanze" checked value="0"/></label></div>
                        <div style="clear:both;"></div>
                    </div>
                    <div class="form-group">
                        <label for="article-title" style="float:left;line-height:34px;">管理员电话：</label>
                        <input type="text" id="tel" name="tel2" class="form-control" placeholder="在此处输入行家电话" required autofocus autocomplete="off" style="float:left;width:200px;">
                        <div style="float:left;line-height:34px;"><label style="padding-left:20px;">显示<input type="radio" name="xuanze" value="1" /></label></div>
                        <div style="clear:both;"></div>
                    </div>
