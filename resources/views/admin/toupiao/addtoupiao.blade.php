            ...
            <form action="{{ url('admin/addToupiaoRes') }}" method="post" class="add-article-form" enctype="multipart/form-data">
                <div class="col-md-9" style="height:700px;overflow-y: auto;padding-bottom:100px;">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" style="width:100%;" name="jieshu"  />
                    </div>
                    <div class="row" >
                ...
                <div class="col-md-3">
                    ...
                    <div class="add-article-box">
                        ...
                        <div class="add-article-box-content">
                            ...
                            <p><label>是否重要：</label><input type="radio" name="ishot" value="1" checked/>重要 <input type="radio" name="ishot" value="0" />不重要</p>
                            <p><label>是否需要签名：</label><input type="radio" name="is_sign" value="1" checked/>是 <input type="radio" name="is_sign" value="0" />否</p>
