        ...
        <ol class="breadcrumb">
            <li>
                ...
                <span style="margin-left:30px;">
                    ...
                    <input type="button" value="重置" onclick="location.href='{{Request::getRequestUri()}}' " class="btn btn-default" style="padding:0;height:24px;width:40px;" />
                </span>
                </form>
            </li>
        </ol>
